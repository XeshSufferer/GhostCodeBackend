...
может отдать 2 ответа:
 ...
 - 500 - Account registration failed. Совпадение логина с уже зарегистрированным аккаунтом.
...
Может отдать 2 ответа:
 ...
 - 500 - Login Failed. Неправильный логин/пароль.
...
Может отдать 2 ответа:
 ...
 - 500 - Ошибка восстановления аккаунта ("Password reset failed"). Неправильный код восстановления
